    ...
    <div className="space-y-10 text-sm leading-relaxed text-ink-soft sm:text-base">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>Notify us immediately at <a href="mailto:hello@clockitt.app" className="font-semibold text-primary underline">hello@clockitt.app</a> if you suspect unauthorised access</li>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <p>
            Because Clockitt offers a free trial before payment is required, all sales are final and non-refundable once payment is completed. If you experience a technical issue preventing access after payment, contact us at <a href="mailto:hello@clockitt.app" className="font-semibold text-primary underline">hello@clockitt.app</a> within 7 days and we will work to resolve it.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          These Terms are governed by applicable laws. Any disputes arising from these Terms or your use of Clockitt should first be directed to us at <a href="mailto:hello@clockitt.app" className="font-semibold text-primary underline">hello@clockitt.app</a>. We will make reasonable efforts to resolve disputes informally before any formal legal proceedings are initiated.
        </p>
      </section>
